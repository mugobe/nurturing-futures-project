                ...
                <div className="space-y-8">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        ...
                        Volunteer Hotline: (123) 456-7892
                      </p>
                      <p className="text-sm text-gray-500 mt-1">
                        Monday to Friday: 9:00 AM - 5:00 PM
                      </p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        General Inquiries: <a href="mailto:info@brightfutures.org" className="text-hope-600 hover:underline">info@brightfutures.org</a><br />
                        Volunteer Opportunities: <a href="mailto:volunteer@brightfutures.org" className="text-hope-600 hover:underline">volunteer@brightfutures.org</a><br />
                        Donations & Support: <a href="mailto:donations@brightfutures.org" className="text-hope-600 hover:underline">donations@brightfutures.org</a>
                      </p>
                    </div>
                  </div>
